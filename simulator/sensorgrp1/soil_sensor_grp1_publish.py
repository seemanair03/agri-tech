...
class AWS:
    ...
    def _openSensorConfigDb(self):
        ...
        print("Opened Sensor config database successfully");
...
if __name__ == '__main__':
    ...
    soil_sensor_1 = AWS("SOIL_SENS_1", "SOIL_SENS_1.pem.crt", "SOIL_SENS_1.pem.key")
    soil_sensor_2 = AWS("SOIL_SENS_2", "SOIL_SENS_2.pem.crt", "SOIL_SENS_2.pem.key")
    soil_sensor_3 = AWS("SOIL_SENS_3", "SOIL_SENS_3.pem.crt", "SOIL_SENS_3.pem.key")
    soil_sensor_4 = AWS("SOIL_SENS_4", "SOIL_SENS_4.pem.crt", "SOIL_SENS_4.pem.key")
