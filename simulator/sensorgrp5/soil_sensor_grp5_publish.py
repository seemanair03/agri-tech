...
if __name__ == '__main__':
    ...
    soil_sensor_17 = AWS("SOIL_SENS_17", "SOIL_SENS_17.pem.crt", "SOIL_SENS_17.pem.key")
    soil_sensor_18 = AWS("SOIL_SENS_18", "SOIL_SENS_18.pem.crt", "SOIL_SENS_18.pem.key")
    soil_sensor_19 = AWS("SOIL_SENS_19", "SOIL_SENS_19.pem.crt", "SOIL_SENS_19.pem.key")
    soil_sensor_20 = AWS("SOIL_SENS_20", "SOIL_SENS_20.pem.crt", "SOIL_SENS_20.pem.key")

    while True:
        try:
            for sensor in (soil_sensor_17,  soil_sensor_18, soil_sensor_19, soil_sensor_20):
                sensor.publish()
