...
class AWS():
    ...
    def _getweather(self):
        ...
        Final_url = BASE_URL + "appid=" + API_KEY + "&lat=" + str(sensorlat) + "&lon=" + str(sensorlon) + "&units=metric"
...
if __name__ == '__main__':
    ...
    soil_sensor_5 = AWS("SOIL_SENS_5", "SOIL_SENS_5.pem.crt", "SOIL_SENS_5.pem.key")
    soil_sensor_6 = AWS("SOIL_SENS_6", "SOIL_SENS_6.pem.crt", "SOIL_SENS_6.pem.key")
    soil_sensor_7 = AWS("SOIL_SENS_7", "SOIL_SENS_7.pem.crt", "SOIL_SENS_7.pem.key")
    soil_sensor_8 = AWS("SOIL_SENS_8", "SOIL_SENS_8.pem.crt", "SOIL_SENS_8.pem.key")

    while True:
        try:
            for sensor in (soil_sensor_5,  soil_sensor_6, soil_sensor_7, soil_sensor_8):
                sensor.publish()
