...
if __name__ == '__main__':
    ...
    soil_sensor_9 = AWS("SOIL_SENS_9", "SOIL_SENS_9.pem.crt", "SOIL_SENS_9.pem.key")
    soil_sensor_10 = AWS("SOIL_SENS_10", "SOIL_SENS_10.pem.crt", "SOIL_SENS_10.pem.key")
    soil_sensor_11 = AWS("SOIL_SENS_11", "SOIL_SENS_11.pem.crt", "SOIL_SENS_11.pem.key")
    soil_sensor_12 = AWS("SOIL_SENS_12", "SOIL_SENS_12.pem.crt", "SOIL_SENS_12.pem.key")

    while True:
        try:
            for sensor in (soil_sensor_9,  soil_sensor_10, soil_sensor_11, soil_sensor_12):
                sensor.publish()
